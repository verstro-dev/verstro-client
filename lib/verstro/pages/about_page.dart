...
class _VerstroAboutPageState extends State<VerstroAboutPage> {
  ...
  Future<void> _open(String url) async {
    ...
    if (await canLaunchUrl(uri)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(appLocalizations.vAboutCannotOpen(url))),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(appLocalizations.vAboutTitle)),
      body: ListView(
        ...
        children: [
              ...
              children: [
                ...
                TextButton.icon(
                  ...
                  label: Text(_checkingUpdate
                      ? appLocalizations.vAboutChecking
                      : appLocalizations.checkUpdate),
                ),
                const SizedBox(height: 4),
                Text(
                  appLocalizations.vAboutSlogan,
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                        color: scheme.onSurfaceVariant,
                      ),
                ),
          ...
          _Section(
            ...
            children: [
              _LinkTile(
                icon: Icons.telegram,
                title: appLocalizations.vAboutTelegramGroup,
                subtitle: '@verstro_chat',
                onTap: () => _open('https://t.me/verstro_chat'),
              ),
              _InfoText(appLocalizations.vSupportPublicGroupPrivacy),
              // feedback@verstro.com 走 CF Email Routing 收信(已开通);
              // 勿用 hello@mail.verstro.com —— mail.* 是 Resend 只发不收域, 无收信 MX, 回信会退。
              _LinkTile(
                icon: Icons.email_outlined,
                title: appLocalizations.vAboutEmail,
                subtitle: 'feedback@verstro.com',
                onTap: () => _open('mailto:feedback@verstro.com'),
              ),
              _InfoText(appLocalizations.vSupportFeedbackPrivacy),
            ],
          ),
          ...
          _Section(
            ...
            children: [
              _LinkTile(
                icon: Icons.language,
                title: appLocalizations.vAboutVisitWebsite,
                subtitle: 'verstro.com',
                onTap: () => _open('https://verstro.com'),
              ),
            ],
          ),
          ...
          // === 隐私承诺 ===
          _Section(
            title: appLocalizations.vAboutPrivacySection,
            children: [
              _InfoText(appLocalizations.vAboutPrivacyBody),
            ],
          ),
          ...
          // === 致谢 ===
          _Section(
            title: appLocalizations.vAboutCreditsSection,
            children: [
              _InfoText(appLocalizations.vAboutCreditsBody),
            ],
          ),
          ...
          // === 开源与许可 (GPLv3 合规入口) ===
          _Section(
            title: appLocalizations.vAboutOssSection,
            children: [
              _InfoText(appLocalizations.vAboutOssBody),
              _LinkTile(
                icon: Icons.code,
                title: appLocalizations.vAboutSourceCode,
