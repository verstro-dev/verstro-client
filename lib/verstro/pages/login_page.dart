...
class _VerstroLoginPageState extends ConsumerState<VerstroLoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(appLocalizations.vAuthLoginTitle)),
      body: SafeArea(
        child: Center(
                  ...
                  children: [
                    ...
                    FilledButton(
                      ...
                      child: loading
                          ...
                          : Text(appLocalizations.vAuthLoginButton),
                    ),
                    ...
                    TextButton(
                      ...
                      child: Text(appLocalizations.vAuthForgotPasswordLink),
                    ),
                    const SizedBox(height: 4),
                    TextButton(
                      key: const Key('login_goto_register'),
                      onPressed: loading ? null : _gotoRegister,
                      child: Text(appLocalizations.vAuthGoToRegister),
                    ),
                  ],
                ),
              ),
