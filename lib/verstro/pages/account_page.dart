...
class _SubscriptionCard extends ConsumerWidget {
  ...
  String _remainingDays(DateTime? expiresAt) {
    ...
    if (diff.inHours >= 1) return appLocalizations.vAcctHoursLater(diff.inHours);
...
class _OrderTile extends StatelessWidget {
  ...
  // 名称部分统一走 localizedPlanName (util/plan_display.dart, 与账号页其余套餐名同源);
  // 价目表是订单卡自身的展示需求 (标价, 非套餐名), 不属于 localizedPlanName 的职责, 保留在此.
  static const _priceSuffix = {
    'monthly': '\$5',
    'quarterly': '\$13',
    'yearly': '\$45',
    'premium-monthly': '\$9',
    'premium-quarterly': '\$23',
    'premium-yearly': '\$79',
  };

  String _planLabel(String id) {
    final name = localizedPlanName(id, id);
    final price = _priceSuffix[id];
