...
class _VerstroPlanPickerPageState extends ConsumerState<VerstroPlanPickerPage> {
  ...
  Widget _buildPlans(BuildContext context, List<PlanDto> plans, String email) {
    ...
    final List<Widget> planSections = premium.isEmpty
        ? [_planGrid(plans)]
        : [
            _tierHeader(context, appLocalizations.vPlanTierStandard,
                appLocalizations.vPlanTierStandardDesc),
            _planGrid(standard),
            const SizedBox(height: 20),
            _tierHeader(context, appLocalizations.vPlanTierPremium,
        ...
        child: Column(
          ...
          children: [
            ...
            _Feature(
                ...
                text: appLocalizations.vPlanTraffic(_formatBytes(plan.trafficLimitBytes))),
            const SizedBox(height: 6),
            _Feature(
              icon: Icons.devices,
            ...
            const SizedBox(height: 6),
            _Feature(icon: Icons.support_agent, text: appLocalizations.vPlanTelegramSupport),
            const SizedBox(height: 20),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            FilledButton.tonal(onPressed: onRetry, child: Text(appLocalizations.vPlanRetry)),
          ],
        ),
      ),
    );
