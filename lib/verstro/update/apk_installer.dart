...
class ApkInstaller {
  ...
  Future<void> downloadAndInstall(
    ...
    try {
      ...
      throw ApkInstallException(appLocalizations.vUpdDownloadFailed('$e'));
    }
    ...
    if (artifact.sha256 != null && artifact.sha256!.isNotEmpty) {
      ...
      if (actual.toLowerCase() != artifact.sha256!.toLowerCase()) {
        await _deleteQuietly(savePath);
        throw ApkInstallException(appLocalizations.vUpdChecksumFailed);
      }
    }
    ...
    try {
      ...
      throw ApkInstallException(
          appLocalizations.vUpdInstallLaunchFailed(e.message ?? e.code));
    }
  }
