                ...
                child: Row(children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(appLocalizations.vAcctAgentCenter,
                          style: Theme.of(context).textTheme.titleMedium),
                      const SizedBox(height: 2),
                      Text(appLocalizations.vAcctAgentEntrySubtitle(a.directCount),
                          maxLines: 1,
                  ...
                  if (a.availableCents > 0)
                    Padding(
                      ...
                      child: Text(
                          appLocalizations
                              .vAcctAgentWithdrawable(_usd(a.availableCents)),
                  ...
                  if (a.tier != 'promoter')
                    Padding(
                      ...
                      child: Chip(
                          label: Text(a.tier == 'master'
                              ? appLocalizations.vAcctAgentTierMaster
                              : appLocalizations.vAcctAgentTierAgent),
