...
const _telegramUri = 'https://t.me/verstro_chat';
          ...
          Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(l10n.vSupportCommunityTitle),
                subtitle: const Text('@verstro_chat'),
                onTap: () => _openExternal(context, _telegramUri),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 0, 16, 12),
                child: Text(
                  l10n.vSupportPublicGroupPrivacy,
