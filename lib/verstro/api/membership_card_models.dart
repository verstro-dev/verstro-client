...
class MembershipCardQuote {
  const MembershipCardQuote({
    ...
    this.promotionalCreditAppliedCents = 0,
  ...
  factory MembershipCardQuote.fromJson(Map<String, dynamic> json) =>
      MembershipCardQuote(
        ...
        promotionalCreditAppliedCents: _int(
          json,
          'promotional_credit_applied_cents',
        ),
        creditAvailableCents: _int(json, 'credit_available_cents'),
        creditAppliedCents: _int(json, 'credit_applied_cents'),
  ...
  final int promotionalCreditAppliedCents;
  ...
  int get displayedCreditAppliedCents {
    if (creditAppliedCents > 0) return creditAppliedCents;
    return cashBackedCreditAppliedCents + promotionalCreditAppliedCents;
  }
}
