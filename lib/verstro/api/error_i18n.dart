...
String? localizedBusinessError(String code) {
  ...
  switch (code) {
    ...
    case 'promotion_service_unavailable':
      return l.vPromotionUnsupported;
    case 'promotion_inactive':
      return l.vPromotionUnavailable;
    case 'promotion_not_eligible':
      return l.vPromotionUnavailable;
    case 'promotion_plan_mismatch':
      return l.vPlanPriceChanged;
    case 'promotion_limit_reached':
    case 'promotion_budget_exhausted':
      return l.vPromotionUnavailable;
    case 'promotion_quote_expired':
    case 'promotion_quote_changed':
      return l.vPromotionQuoteExpired;
    case 'promotion_partner_price_conflict':
      return l.vErrCouponPartnerPriceConflict;
