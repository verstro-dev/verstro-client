  ...
  Future<Map<String, dynamic>> _request(
    ...
    if (code >= 200 && code < 300) {
      ...
      throw ServerException(
          appLocalizations.vApiUnexpectedResponseType(data.runtimeType), code);
    }
    ...
    switch (code) {
      ...
      case 409:
        ...
        return ConflictException(
            errCode, errMsg.isEmpty ? appLocalizations.vApiConflict : errMsg);
      case 403:
        return ForbiddenException(
            errCode, errMsg.isEmpty ? appLocalizations.vApiForbidden : errMsg);
      case 400:
        return BadRequestException(
            errCode, errMsg.isEmpty ? appLocalizations.vApiBadRequest : errMsg);
      case 404:
      ...
      default:
        if (code >= 500) {
          return ServerException(
            errMsg.isEmpty ? appLocalizations.vApiServerErrorStatus(code) : errMsg,
            code,
          );
        }
        return ServerException(
            errMsg.isEmpty ? appLocalizations.vApiUnexpectedStatus(code) : errMsg, code);
    }
  }
}
