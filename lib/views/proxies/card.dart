...
class ProxyCard extends StatelessWidget {
  ...
  Widget _buildProxyNameText(BuildContext context) {
    // 国旗 + 本地化国名 (按节点名推断); 国旗由 EmojiText 用 Twemoji 字体渲染。
...
// 按节点名推断国家 → 国旗 emoji + 本地化国名, 前缀到代理卡片展示名。
...
// 国名走 arb 本地化 (运行时取, 不能进 const 上下文)。
String? _proxyCountryLabel(String code) => switch (code) {
  'US' => appLocalizations.vAppCountryUs,
  'JP' => appLocalizations.vAppCountryJp,
  'SG' => appLocalizations.vAppCountrySg,
  'HK' => appLocalizations.vAppCountryHk,
  'TW' => appLocalizations.vAppCountryTw,
  'MO' => appLocalizations.vAppCountryMo,
  'KR' => appLocalizations.vAppCountryKr,
  'GB' => appLocalizations.vAppCountryGb,
  'DE' => appLocalizations.vAppCountryDe,
  'FR' => appLocalizations.vAppCountryFr,
  'NL' => appLocalizations.vAppCountryNl,
  'RU' => appLocalizations.vAppCountryRu,
  'TR' => appLocalizations.vAppCountryTr,
  'IN' => appLocalizations.vAppCountryIn,
  'AU' => appLocalizations.vAppCountryAu,
  'CA' => appLocalizations.vAppCountryCa,
  'VN' => appLocalizations.vAppCountryVn,
  'TH' => appLocalizations.vAppCountryTh,
  'MY' => appLocalizations.vAppCountryMy,
  'PH' => appLocalizations.vAppCountryPh,
  'ID' => appLocalizations.vAppCountryId,
  'CN' => appLocalizations.vAppCountryCn,
  _ => null,
};
...
String proxyCountryPrefix(String proxyName) {
  for (final token in proxyName.toLowerCase().split(RegExp(r'[^a-z0-9]+'))) {
    ...
    if (code != null) {
      return '${_countryFlagEmoji(code)} ${_proxyCountryLabel(code) ?? code} ';
    }
  }
  return '';
}
