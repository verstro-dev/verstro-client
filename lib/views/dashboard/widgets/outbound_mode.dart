                  ...
                  child: LayoutBuilder(
                    builder: (_, constraints) {
                      ...
                      return Column(
                        ...
                        children: [
                          for (final item in ModeExt.visibleValues)
                            ListItem.radio(
                              horizontalTitleGap: 8,
                              tileTitleAlignment: ListTileTitleAlignment.center,
                              minTileHeight: min(
                                maxHeight / ModeExt.visibleValues.length,
...
class OutboundModeV2 extends StatelessWidget {
  ...
  Color _getTextColor(BuildContext context, Mode mode) {
    return switch (mode) {
      ...
      // 穷举占位：direct 已从 visibleValues 隐藏，实际不被触发，勿删(switch 需穷举)。
