...
class _DashboardViewState extends ConsumerState<DashboardView> {
  static const _toolbarButtonSize = 48.0;
  static const _toolbarIconSize = 24.0;
  static const _connectionIndicatorSize = 36.0;
  ...
  ButtonStyle get _toolbarIconButtonStyle => IconButton.styleFrom(
    fixedSize: const Size.square(_toolbarButtonSize),
  ...
  List<Widget> _buildActions(bool isEdit) {
    return [
            ...
            return Tooltip(
              ...
              child: FadeScaleBox(
                ...
                child: coreStatus == CoreStatus.connected
                    ? IconButton(
                        key: const ValueKey('dashboard-connection'),
                        ...
                        icon: DecoratedBox(
                          ...
                          child: const SizedBox.square(
                            dimension: _connectionIndicatorSize,
                            child: Icon(
                              Icons.check,
      ...
      if (!isEdit)
        IconButton(
          key: const ValueKey('dashboard-help'),
          tooltip: appLocalizations.vHelpTitle,
          style: _toolbarIconButtonStyle,
          onPressed: () => openVerstroHelpCenter(context),
