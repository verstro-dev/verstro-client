...
// Verstro 2.5 品牌化: 显示名与技术标识分离.
// appDisplayName — 用户可见的品牌名 (启动器/窗口标题/托盘/关于页). 改这个.
const appDisplayName = 'Verstro';
// appName — 技术标识, 勿改! 同时用作:
//   - 订阅请求 User-Agent ('$appName/v$version', 见 package.dart); 含 "Clash"
//     是订阅服务端识别 clash 订阅格式返回 YAML 的关键, 改了订阅链路 (keystone) 崩
//   - TUN device 名 / 备份+日志文件名 / isolate 名 / unix socket / WebDAV 根路径
// 保留上游值, 用户不可见.
