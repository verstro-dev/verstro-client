...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m62(amount) => "已确认，订阅已开通。多付的 ${amount} 已存入账户余额，下次购买自动抵扣。";

  static String m63(amount) =>
      "该订单已过期，但我们收到了这笔转账。${amount} 已全额存入账户余额。请重新下单——余额自动抵扣，足额立即开通。";

  static String m64(amount) => "${amount} 已存入账户余额。请重新下单——余额自动抵扣。";
  ...
  static String m67(id) => "订单 #${id} 在 24 小时内未收到付款, 已自动作废.";

  static String m68(id) => "订单 #${id}";

  static String m69(plan, id) => "${plan} 订单 #${id}";

  static String m70(error) => "提交失败: ${error}";

  static String m71(email) => "账号: ${email}";

  static String m72(error) => "创建订单失败: ${error}";

  static String m73(days) => "${days} 天有效";

  static String m74(error) => "加载套餐失败: ${error}";

  static String m75(count) => "${count} 台设备同时在线";

  static String m76(price) => "约 \$${price} / 月";

  static String m77(amount) => "${amount} 流量";
  ...
  static String m81(prefix, amount) => "${prefix}，首购后你我各得 ${amount} 抵扣。";

  static String m82(prefix) => "${prefix}。";

  static String m83(code) => "注册时填我的邀请码 ${code}";

  static String m84(code) => "注册填邀请码 ${code}";

  static String m85(prefix, amount) => "${prefix}，首购后可得 ${amount} 抵扣。";

  static String m86(amount) => "填码注册 · 首购后你我各得 ${amount}";

  static String m87(amount) => "填码注册 · 首购得 ${amount} 抵扣";

  static String m88(days) => "免费试用 ${days} 天";

  static String m89(trial, gb) => "新用户${trial}${gb}";

  static String m90(days) => "新用户可免费试用 ${days} 天。";

  static String m91(days, gb) => "${days} 天 · ${gb}GB 流量";

  static String m92(days) => "验证邮箱后可领取 ${days} 天免费试用（输入邮件里的 6 位验证码）";

  static String m93(error) => "下载失败: ${error}";

  static String m94(percent) => "下载中 ${percent}%";

  static String m95(version) => "需要更新到 v${version}";

  static String m96(error) => "调起安装失败: ${error}";

  static String m97(version) => "发现新版本 v${version}";

  static String m98(error) => "更新失败: ${error}";
