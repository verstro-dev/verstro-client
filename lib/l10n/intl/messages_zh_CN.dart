...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m93(prefix, amount) => "${prefix}，首购后你我各得 ${amount} 抵扣。";

  static String m94(prefix) => "${prefix}。";

  static String m95(code) => "注册时填我的邀请码 ${code}";

  static String m96(code) => "注册填邀请码 ${code}";

  static String m97(prefix, amount) => "${prefix}，首购后可得 ${amount} 抵扣。";

  static String m98(amount) => "填码注册 · 首购后你我各得 ${amount}";

  static String m99(amount) => "填码注册 · 首购得 ${amount} 抵扣";

  static String m100(days) => "免费试用 ${days} 天";

  static String m101(trial, gb) => "新用户${trial}${gb}";

  static String m102(days) => "新用户可免费试用 ${days} 天。";

  static String m103(days, gb) => "${days} 天 · ${gb}GB 流量";

  static String m104(days) => "验证邮箱后可领取 ${days} 天免费试用（输入邮件里的 6 位验证码）";

  static String m105(error) => "下载失败: ${error}";

  static String m106(percent) => "下载中 ${percent}%";

  static String m107(version) => "需要更新到 v${version}";

  static String m108(error) => "调起安装失败: ${error}";

  static String m109(version) => "发现新版本 v${version}";

  static String m110(error) => "更新失败: ${error}";
