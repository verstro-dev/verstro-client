...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m77(code) => "授权编号 ${code}";

  static String m78(basePrice) =>
      "套餐基价 \$${basePrice} + 防冲突尾数. 多 0.01 或少 0.01 都无法自动匹配, 请检查钱包「金额」字段是否一致到小数点后 2 位.";

  static String m79(id) => "订单 #${id} 在 24 小时内未收到付款, 已自动作废.";

  static String m80(id) => "订单 #${id}";

  static String m81(plan, id) => "${plan} 订单 #${id}";

  static String m82(error) => "提交失败: ${error}";

  static String m83(email) => "账号: ${email}";

  static String m84(error) => "创建订单失败: ${error}";

  static String m85(days) => "${days} 天有效";

  static String m86(error) => "加载套餐失败: ${error}";

  static String m87(count) => "${count} 台设备同时在线";

  static String m88(price) => "约 \$${price} / 月";

  static String m89(amount) => "${amount} 流量";

  static String m90(amount) => "已减免 ${amount}";

  static String m91(error) => "无法获取优惠报价：${error}";
  ...
  static String m95(prefix, amount) => "${prefix}，首购后你我各得 ${amount} 抵扣。";

  static String m96(prefix) => "${prefix}。";

  static String m97(code) => "注册时填我的邀请码 ${code}";

  static String m98(code) => "注册填邀请码 ${code}";

  static String m99(prefix, amount) => "${prefix}，首购后可得 ${amount} 抵扣。";

  static String m100(amount) => "填码注册 · 首购后你我各得 ${amount}";

  static String m101(amount) => "填码注册 · 首购得 ${amount} 抵扣";

  static String m102(days) => "免费试用 ${days} 天";

  static String m103(trial, gb) => "新用户${trial}${gb}";

  static String m104(days) => "新用户可免费试用 ${days} 天。";

  static String m105(days, gb) => "${days} 天 · ${gb}GB 流量";

  static String m106(days) => "验证邮箱后可领取 ${days} 天免费试用（输入邮件里的 6 位验证码）";

  static String m107(error) => "下载失败: ${error}";

  static String m108(percent) => "下载中 ${percent}%";

  static String m109(version) => "需要更新到 v${version}";

  static String m110(error) => "调起安装失败: ${error}";

  static String m111(version) => "发现新版本 v${version}";

  static String m112(error) => "更新失败: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vHelpContactBody": MessageLookupByLibrary.simpleMessage(
      "联系支持时请说明设备平台、应用版本、网络环境、节点和复现步骤；不要发送密码、完整付款凭据或其他敏感信息。",
    ),
    "vHelpContactTitle": MessageLookupByLibrary.simpleMessage("联系客服"),
