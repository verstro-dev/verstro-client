...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m73(amount) => "付款已确认，请刷新权益核实生效状态。多付的 ${amount} 已存入账户余额。";
  ...
  static String m78(count) => "已通过 ${count} 笔付款完成支付，请刷新权益核实生效状态。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctOrderPayCredit": MessageLookupByLibrary.simpleMessage("余额"),
    "vAcctOrderPayNew": MessageLookupByLibrary.simpleMessage("新支付"),
    ...
    "vAcctReusablePendingExpired": MessageLookupByLibrary.simpleMessage(
      "已包含在可用余额中，原订单已到期，请勿继续付款。",
    ),
    "vAcctReusablePendingSubtitle": MessageLookupByLibrary.simpleMessage(
      "上述可用余额已包含这笔资金，请勿重复相加。可继续补付；改买新订单将关闭旧订单并转用资金。",
    ),
    ...
    "vCardCashBackedApplied": MessageLookupByLibrary.simpleMessage("余额抵扣"),
    ...
    "vClaimActivated": MessageLookupByLibrary.simpleMessage(
      "付款已确认，权益可能已生效、排队或配置处理中，请刷新权益核实。",
    ),
    ...
    "vConvAcceptQuote": MessageLookupByLibrary.simpleMessage("接受新报价并生成付款单"),
    "vConvAwaiting": MessageLookupByLibrary.simpleMessage("待补款：原权益继续正常使用"),
    "vConvCancel": MessageLookupByLibrary.simpleMessage("取消换购并释放占用资金"),
    "vConvCancelled": MessageLookupByLibrary.simpleMessage(
      "换购已取消，已到账款项按规则释放为可购买资金",
    ),
    "vConvCarry": MessageLookupByLibrary.simpleMessage("原付款单转用资金"),
    "vConvCompleted": MessageLookupByLibrary.simpleMessage("换购已完成"),
    "vConvConfirm": MessageLookupByLibrary.simpleMessage("确认并继续换购"),
    "vConvConverted": MessageLookupByLibrary.simpleMessage("已折价转换"),
    "vConvCreate": MessageLookupByLibrary.simpleMessage("确认此报价并创建换购"),
    "vConvEndHint": MessageLookupByLibrary.simpleMessage(
      "仅参与折价的旧权益会在结算成功后结束，其余保留。付款成功不等于服务已生效。",
    ),
    "vConvExpired": MessageLookupByLibrary.simpleMessage("换购已超时，请勿向旧付款单继续付款"),
    "vConvHeld": MessageLookupByLibrary.simpleMessage("换购占用资金（不计入可用余额）"),
    "vConvIdentity": MessageLookupByLibrary.simpleMessage("换购编号"),
    "vConvLogin": MessageLookupByLibrary.simpleMessage("请先登录后查看换购"),
    "vConvNew": MessageLookupByLibrary.simpleMessage("开始新的预览"),
    "vConvOpen": MessageLookupByLibrary.simpleMessage("查看换购状态"),
    "vConvOpenPayment": MessageLookupByLibrary.simpleMessage("查看付款单 / 核验已付款"),
    "vConvQuoteExpired": MessageLookupByLibrary.simpleMessage("报价已过期，请先重新报价"),
    "vConvReconfirm": MessageLookupByLibrary.simpleMessage("待确认：请核对当前报价及资金明细"),
    "vConvRecovery": MessageLookupByLibrary.simpleMessage(
      "安全恢复处理中：资金和权益保留，请刷新状态或联系客服",
    ),
    "vConvRecoveryHint": MessageLookupByLibrary.simpleMessage(
      "请选择已过期换购的实际到账款，然后重新获取报价。仅抵扣升级补差，多余留在余额；余额开关只控制其他钱包资金。",
    ),
    "vConvRecoveryNone": MessageLookupByLibrary.simpleMessage("不使用原付款"),
    "vConvRecoverySource": MessageLookupByLibrary.simpleMessage("已过期付款来源"),
    "vConvRefresh": MessageLookupByLibrary.simpleMessage("刷新换购状态"),
    "vConvRequote": MessageLookupByLibrary.simpleMessage("重新报价（不扣款）"),
    "vConvRetryCreate": MessageLookupByLibrary.simpleMessage("重试创建（使用原幂等请求）"),
    "vConvSettling": MessageLookupByLibrary.simpleMessage("正在核验最终用量，请勿重复操作"),
    "vConvSource": MessageLookupByLibrary.simpleMessage("换购周期"),
    "vConvSync": MessageLookupByLibrary.simpleMessage("权益已转换，正在同步实际服务配置"),
    "vConvUnknown": MessageLookupByLibrary.simpleMessage(
      "请求结果尚未确认。已有换购请刷新状态；创建请求重试会沿用原幂等键，不另建订单。",
    ),
    "vEntActive": MessageLookupByLibrary.simpleMessage("已生效"),
    "vEntAdmissionClosed": MessageLookupByLibrary.simpleMessage(
      "换购入口暂未开放，当前仅可预览。未占用资金或原权益。",
    ),
    "vEntAfter": MessageLookupByLibrary.simpleMessage("新增权益总量（各周期独立接续）"),
    "vEntAmounts": MessageLookupByLibrary.simpleMessage("旧权益折价 / 账户抵扣 / 待付"),
    "vEntApproxValue": MessageLookupByLibrary.simpleMessage("预计折价（约）"),
    "vEntAsOf": MessageLookupByLibrary.simpleMessage("估值时点 / 有效至"),
    "vEntAutomatic": MessageLookupByLibrary.simpleMessage("自动选节点"),
    "vEntBefore": MessageLookupByLibrary.simpleMessage("参与折价的原权益"),
    "vEntCard": MessageLookupByLibrary.simpleMessage("会员卡"),
    "vEntCompareHint": MessageLookupByLibrary.simpleMessage(
      "折价金额覆盖不保证时长或流量不减少。新增各周期独立接续，不一次放行全部流量。",
    ),
    "vEntComparison": MessageLookupByLibrary.simpleMessage("转换前 / 新增周期总量"),
    "vEntConfirmed": MessageLookupByLibrary.simpleMessage("付款已确认；生效状态以权益快照为准"),
    "vEntCredit": MessageLookupByLibrary.simpleMessage("使用账户余额"),
    "vEntCreditApplied": MessageLookupByLibrary.simpleMessage("账户余额抵扣"),
    "vEntCurrent": MessageLookupByLibrary.simpleMessage("生效权益"),
    "vEntDetails": MessageLookupByLibrary.simpleMessage("查看估值依据"),
    "vEntDevices": MessageLookupByLibrary.simpleMessage("设备上限"),
    "vEntDiscount": MessageLookupByLibrary.simpleMessage("营销优惠"),
    "vEntDue": MessageLookupByLibrary.simpleMessage("待支付金额"),
    "vEntDuration": MessageLookupByLibrary.simpleMessage("服务时长"),
    "vEntEligible": MessageLookupByLibrary.simpleMessage("参与折价"),
    "vEntEmpty": MessageLookupByLibrary.simpleMessage("暂无记录"),
    "vEntError": MessageLookupByLibrary.simpleMessage("权益加载失败，请重试"),
    "vEntEstimate": MessageLookupByLibrary.simpleMessage(
      "预计顺序与日期可能因提前耗尽或高档插入变化；未来流量不计入当前可用量。",
    ),
    "vEntEstimated": MessageLookupByLibrary.simpleMessage("预计"),
    "vEntExcluded": MessageLookupByLibrary.simpleMessage("不参与折价"),
    "vEntExcludedAdjusted": MessageLookupByLibrary.simpleMessage(
      "存在退款或权益调整，无法可靠重建估值基数，保留原权益。",
    ),
    "vEntExcludedEmpty": MessageLookupByLibrary.simpleMessage("没有可转换的剩余服务价值。"),
    ...
    "vEntExcludedUnknown": MessageLookupByLibrary.simpleMessage(
      "无法可靠核验历史资金或购买快照，保留原权益。",
    ),
    "vEntExcludedUnpaid": MessageLookupByLibrary.simpleMessage(
      "卡片未形成可核验的已支付资金，不参与折价。",
    ),
    "vEntExhausted": MessageLookupByLibrary.simpleMessage("已耗尽"),
    "vEntExpired": MessageLookupByLibrary.simpleMessage("已到期"),
    "vEntHistory": MessageLookupByLibrary.simpleMessage("历史权益"),
    "vEntHistoryChanged": MessageLookupByLibrary.simpleMessage(
      "历史已变化，请刷新全部权益；已加载记录暂时保留。",
    ),
    "vEntHistoryError": MessageLookupByLibrary.simpleMessage("历史加载失败，请重试。"),
    "vEntIfImmediate": MessageLookupByLibrary.simpleMessage(
      "若未来可执行，将立即开始新周期；本次仅预览。",
    ),
    "vEntIfQueued": MessageLookupByLibrary.simpleMessage(
      "若未来可执行，将排在当前服务之后；不会重置当前专业套餐。",
    ),
    "vEntIndependent": MessageLookupByLibrary.simpleMessage("独立购买套餐（不折价）"),
    "vEntManual": MessageLookupByLibrary.simpleMessage("手动选节点"),
    "vEntMore": MessageLookupByLibrary.simpleMessage("加载更多历史"),
    "vEntNet": MessageLookupByLibrary.simpleMessage("优惠后商品价"),
    "vEntNoAvailable": MessageLookupByLibrary.simpleMessage(
      "当前没有可购买的目标套餐，请稍后重试。",
    ),
    "vEntNoEligible": MessageLookupByLibrary.simpleMessage(
      "没有可折价的低档权益，请查看各来源排除原因。",
    ),
    "vEntNoTarget": MessageLookupByLibrary.simpleMessage("没有可完整覆盖折价的合法套餐"),
    "vEntNone": MessageLookupByLibrary.simpleMessage("暂无已生效服务"),
    "vEntOrder": MessageLookupByLibrary.simpleMessage("订单"),
    "vEntOriginal": MessageLookupByLibrary.simpleMessage("商品原价"),
    "vEntPaused": MessageLookupByLibrary.simpleMessage("已暂停"),
    "vEntPending": MessageLookupByLibrary.simpleMessage("排期或暂停"),
    "vEntPeriod": MessageLookupByLibrary.simpleMessage("服务区间"),
    "vEntPrice": MessageLookupByLibrary.simpleMessage("商品原价 / 优惠 / 优惠后价"),
    "vEntProcessing": MessageLookupByLibrary.simpleMessage("配置处理中，请刷新核实"),
    "vEntPurchaseValue": MessageLookupByLibrary.simpleMessage("可核验购买价值"),
    "vEntQuantity": MessageLookupByLibrary.simpleMessage(
      "套餐版本 / 数量 / 总天数 / 总流量",
    ),
    "vEntQuote": MessageLookupByLibrary.simpleMessage("获取只读报价"),
    "vEntQuoteError": MessageLookupByLibrary.simpleMessage("报价失败，请重试；未创建普通订单"),
    "vEntRefresh": MessageLookupByLibrary.simpleMessage("刷新全部权益"),
    "vEntRefundNote": MessageLookupByLibrary.simpleMessage(
      "表示该笔剩余权益已收回，不代表全部现金已退款。",
    ),
    "vEntRefunded": MessageLookupByLibrary.simpleMessage("退款收回"),
    "vEntRemaining": MessageLookupByLibrary.simpleMessage("剩余流量"),
    "vEntRetained": MessageLookupByLibrary.simpleMessage(
      "没有创建新权益或配置任务，原权益保持不变。",
    ),
    "vEntReview": MessageLookupByLibrary.simpleMessage("权益需要人工核验，当前权限不作保证"),
    "vEntRevoked": MessageLookupByLibrary.simpleMessage("已撤销"),
    "vEntScheduled": MessageLookupByLibrary.simpleMessage("已排队"),
    "vEntSeconds": MessageLookupByLibrary.simpleMessage("剩余服务秒数"),
    "vEntService": MessageLookupByLibrary.simpleMessage("当前有效服务"),
    "vEntServiceTime": MessageLookupByLibrary.simpleMessage("剩余服务时长"),
    "vEntSource": MessageLookupByLibrary.simpleMessage("来源"),
    "vEntSources": MessageLookupByLibrary.simpleMessage("折价来源与排除原因"),
    "vEntTarget": MessageLookupByLibrary.simpleMessage("目标档位"),
    "vEntTitle": MessageLookupByLibrary.simpleMessage("我的套餐权益"),
    "vEntTraffic": MessageLookupByLibrary.simpleMessage("总流量"),
    "vEntUnsupported": MessageLookupByLibrary.simpleMessage(
      "暂不支持可靠截止计量，无法执行换购。未占用资金或原权益。",
    ),
    "vEntUnverified": MessageLookupByLibrary.simpleMessage("现有服务尚未通过权益核验"),
    "vEntUpgrade": MessageLookupByLibrary.simpleMessage("折价升级预览"),
    "vEntUsage": MessageLookupByLibrary.simpleMessage("已用 / 总流量"),
    "vEntValue": MessageLookupByLibrary.simpleMessage("旧权益折价合计"),
    ...
    "vHelpSystemProxyBody": MessageLookupByLibrary.simpleMessage(
      "开启后，Verstro 写入系统代理设置，浏览器等遵循系统代理的软件会进入 Verstro；关闭后它们不再经该路径进入。无需创建虚拟网卡、权限要求较低，但终端工具、Git、Docker、游戏和部分桌面应用可能忽略它。若强制退出后网页打不开，再打开一次 Verstro 会清掉残留系统代理，也可在系统设置里关闭代理。",
    ),
    ...
    "vPayLocalExpiryDesc": MessageLookupByLibrary.simpleMessage(
      "请勿继续转账。正在等待服务器确认最终状态；若已付款，请提交交易号核实已付资金。",
    ),
    ...
    "vPaySubscriptionActivated": MessageLookupByLibrary.simpleMessage("付款结果"),
    ...
    "vPromotionCreditPreview": MessageLookupByLibrary.simpleMessage("预计应付"),
    ...
    "yearsAgo": m118,
    "vEntRenewPremium": MessageLookupByLibrary.simpleMessage('续购专业'),
    "vEntRenewStandard": MessageLookupByLibrary.simpleMessage('续购标准'),
    "vAcctOrdersEntitlements": MessageLookupByLibrary.simpleMessage('订单与权益记录'),
    "vAcctEntitlementTab": MessageLookupByLibrary.simpleMessage('权益记录'),
    "vAcctOrderTab": MessageLookupByLibrary.simpleMessage('订单'),
    "vPlanOtherPlans": MessageLookupByLibrary.simpleMessage('其他套餐'),
    "vPlanStandardAfterPremium": MessageLookupByLibrary.simpleMessage(
      '仅在所有专业权益结束后生效，不会立即降低当前服务档位。',
    ),
    "vEntResumeConversion": MessageLookupByLibrary.simpleMessage('继续待处理升级'),
    "vEntUpgradePremium": MessageLookupByLibrary.simpleMessage('升级专业'),
    "vEntConvertStandardToPremium": MessageLookupByLibrary.simpleMessage(
      '标准权益转为专业续期',
    ),
    "vPlanTierUnknown": MessageLookupByLibrary.simpleMessage('套餐能力待确认'),
    "vPlanTierUnknownDesc": MessageLookupByLibrary.simpleMessage(
      '无法识别此套餐档位，购买前请核对服务端当前说明。',
    ),
