...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "Баланс списывается после скидки · средства незавершённых заказов не входят в доступный баланс",
    ),
    ...
    "vAcctCreditError": MessageLookupByLibrary.simpleMessage(
      "Не удалось загрузить баланс. Повторите попытку",
    ),
    "vAcctDaysLater": m22,
    ...
    "vAcctOrderPayCredit": MessageLookupByLibrary.simpleMessage("Баланс"),
    "vAcctOrderPayNew": MessageLookupByLibrary.simpleMessage("Новая оплата"),
    ...
    "vAcctPendingSubtitle": MessageLookupByLibrary.simpleMessage(
      "Средства закреплены за этими заказами и недоступны для других покупок.",
    ),
    "vAcctPendingTitle": MessageLookupByLibrary.simpleMessage(
      "Получено по заказам с доплатой",
    ),
    "vAcctPendingTransfer": MessageLookupByLibrary.simpleMessage(
      "Ожидает перевода на баланс",
    ),
    ...
    "vAcctPurchaseBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "Включает неизрасходованные средства заказов · баланс списывается после скидки",
    ),
    ...
    "vAcctReusablePendingExpired": MessageLookupByLibrary.simpleMessage(
      "Включено в доступный баланс. Заказ истёк; больше не переводите средства.",
    ),
    "vAcctReusablePendingSubtitle": MessageLookupByLibrary.simpleMessage(
      "Уже включено в доступный баланс выше. Не прибавляйте повторно. Доплатите или создайте новый заказ: старый закроется, а средства будут использованы.",
    ),
    ...
    "vCardCashBackedApplied": MessageLookupByLibrary.simpleMessage("Списание баланса"),
    "vCardUseCashBacked": MessageLookupByLibrary.simpleMessage(
      "Использовать баланс счёта (закрывает неоплаченные заказы тарифов и освобождает их скидки)",
    ),
    ...
    "vConvAcceptQuote": MessageLookupByLibrary.simpleMessage(
      "Принять новый расчёт и платёжный заказ",
    ),
    "vConvAwaiting": MessageLookupByLibrary.simpleMessage(
      "Ожидание доплаты; текущая услуга продолжается",
    ),
    "vConvCancel": MessageLookupByLibrary.simpleMessage(
      "Отменить обмен и освободить средства",
    ),
    "vConvCancelled": MessageLookupByLibrary.simpleMessage(
      "Обмен отменён; поступившие средства освобождаются по правилам баланса",
    ),
    "vConvCarry": MessageLookupByLibrary.simpleMessage(
      "Средства из предыдущего платежа",
    ),
    "vConvCompleted": MessageLookupByLibrary.simpleMessage("Обмен завершён"),
    "vConvConfirm": MessageLookupByLibrary.simpleMessage(
      "Подтвердить и продолжить",
    ),
    "vConvConverted": MessageLookupByLibrary.simpleMessage("Преобразовано"),
    "vConvCreate": MessageLookupByLibrary.simpleMessage(
      "Принять расчёт и создать обмен",
    ),
    "vConvEndHint": MessageLookupByLibrary.simpleMessage(
      "После успешного расчёта прекращаются только включённые старые права; остальные сохраняются. Оплата не означает активацию услуги.",
    ),
    "vConvExpired": MessageLookupByLibrary.simpleMessage(
      "Срок обмена истёк. Не оплачивайте старый заказ",
    ),
    "vConvHeld": MessageLookupByLibrary.simpleMessage(
      "Средства обмена в резерве (не входят в доступный баланс)",
    ),
    "vConvIdentity": MessageLookupByLibrary.simpleMessage("Номер обмена"),
    "vConvLogin": MessageLookupByLibrary.simpleMessage(
      "Войдите, чтобы посмотреть обмен",
    ),
    "vConvNew": MessageLookupByLibrary.simpleMessage(
      "Начать новый предварительный расчёт",
    ),
    "vConvOpen": MessageLookupByLibrary.simpleMessage(
      "Посмотреть статус обмена",
    ),
    "vConvOpenPayment": MessageLookupByLibrary.simpleMessage(
      "Посмотреть платёж / проверить перевод",
    ),
    "vConvQuoteExpired": MessageLookupByLibrary.simpleMessage(
      "Расчёт устарел. Запросите новый",
    ),
    "vConvReconfirm": MessageLookupByLibrary.simpleMessage(
      "Проверьте расчёт и источники средств перед подтверждением",
    ),
    "vConvRecovery": MessageLookupByLibrary.simpleMessage(
      "Идёт безопасное восстановление. Обновите статус или обратитесь в поддержку",
    ),
    "vConvRecoveryHint": MessageLookupByLibrary.simpleMessage(
      "Выберите поступившие средства истёкшего обмена и запросите новый расчёт. Покрывается только доплата; остаток остаётся на балансе. Переключатель баланса влияет только на другие средства кошелька.",
    ),
    "vConvRecoveryNone": MessageLookupByLibrary.simpleMessage(
      "Не использовать прошлый платёж",
    ),
    "vConvRecoverySource": MessageLookupByLibrary.simpleMessage(
      "Средства истёкшего платежа",
    ),
    "vConvRefresh": MessageLookupByLibrary.simpleMessage(
      "Обновить статус обмена",
    ),
    "vConvRequote": MessageLookupByLibrary.simpleMessage(
      "Обновить расчёт (без списания)",
    ),
    "vConvRetryCreate": MessageLookupByLibrary.simpleMessage(
      "Повторить тот же запрос создания",
    ),
    "vConvSettling": MessageLookupByLibrary.simpleMessage(
      "Проверяется итоговый расход. Не повторяйте операцию",
    ),
    "vConvSource": MessageLookupByLibrary.simpleMessage("Период обмена"),
    "vConvSync": MessageLookupByLibrary.simpleMessage(
      "Обмен проведён; конфигурация услуги синхронизируется",
    ),
    "vConvUnknown": MessageLookupByLibrary.simpleMessage(
      "Результат не подтверждён. Обновите обмен или повторите тот же запрос создания. Не платите повторно.",
    ),
    ...
    "vHelpSystemProxyBody": MessageLookupByLibrary.simpleMessage(
      "При включении Verstro записывает системные настройки прокси, поэтому браузеры и другие приложения, соблюдающие системный прокси, попадают в Verstro. При выключении этот путь больше не используется. Не требуется виртуальный адаптер и нужно меньше разрешений, но терминалы, Git, Docker, игры и некоторые настольные приложения могут его игнорировать. Если после принудительного завершения страницы не открываются, снова откройте Verstro — оно снимет оставшийся системный прокси, — либо отключите прокси в настройках системы.",
    ),
    ...
    "vPayLocalExpiryDesc": MessageLookupByLibrary.simpleMessage(
      "Не переводите дополнительные средства. Ожидается подтверждение сервера. Если вы уже оплатили, отправьте ID транзакции для проверки.",
    ),
    ...
    "vPlanRenewalExhausted": MessageLookupByLibrary.simpleMessage(
      "Трафик тарифа израсходован. Купите снова ниже. VPN заработает после активации.",
    ),
    "vPlanRenewalExpired": MessageLookupByLibrary.simpleMessage(
      "Срок тарифа истёк. Купите снова ниже. VPN заработает после активации.",
    ),
    "vPlanRenewalNone": MessageLookupByLibrary.simpleMessage(
      "Нет активного тарифа. Выберите план и оплатите, чтобы начать.",
    ),
    ...
    "vPromotionCreditBlocked": MessageLookupByLibrary.simpleMessage(
      "Эту акцию нельзя сочетать с балансом. К оплате цена после скидки.",
    ),
    ...
    "vPurchaseAutomaticHint": MessageLookupByLibrary.simpleMessage(
      "По умолчанию: повышение уровня открывает предпросмотр обмена; тот же уровень продлевается, низший ждёт. Предпросмотр не создаёт заказ.",
    ),
    "vPurchaseEntitlementsUnverified": MessageLookupByLibrary.simpleMessage(
      "Не удалось проверить права. Обновите данные и выберите тариф заново. Не оплачивайте этот запрос.",
    ),
    "vPurchaseHistoryReview": MessageLookupByLibrary.simpleMessage(
      "История сервиса требует проверки. Подтвердите только новую оплату без конвертации старых прав.",
    ),
    "vPurchaseHistoryReviewBody": MessageLookupByLibrary.simpleMessage(
      "Будет открыт новый оплаченный сервис без конвертации прежних прав. Независимая покупка никогда не выбирается автоматически.",
    ),
    "vPurchaseHistoryReviewOk": MessageLookupByLibrary.simpleMessage(
      "Оплатить новый сервис",
    ),
    "vPurchaseHistoryReviewTitle": MessageLookupByLibrary.simpleMessage(
      "Подтвердить независимую покупку",
    ),
    "vPurchaseIndependentHint": MessageLookupByLibrary.simpleMessage(
      "Отдельная покупка: без зачёта действующих прав. Для нового заказа явно выберите тариф.",
    ),
    "vPurchaseUpgradeRequired": MessageLookupByLibrary.simpleMessage(
      "Требуется предпросмотр повышения тарифа. Обновите данные и выберите тариф заново. Заказ не создан.",
    ),
    ...
    "yearsAgo": m118,
    "vEntRenewPremium": MessageLookupByLibrary.simpleMessage('Продлить Pro'),
    "vEntRenewStandard": MessageLookupByLibrary.simpleMessage(
      'Продлить Standard',
    ),
    "vAcctOrdersEntitlements": MessageLookupByLibrary.simpleMessage(
      'Заказы и права',
    ),
    "vAcctEntitlementTab": MessageLookupByLibrary.simpleMessage('Права'),
    "vAcctOrderTab": MessageLookupByLibrary.simpleMessage('Заказы'),
    "vPlanOtherPlans": MessageLookupByLibrary.simpleMessage('Другие планы'),
    "vPlanStandardAfterPremium": MessageLookupByLibrary.simpleMessage(
      'Начнется только после окончания всех прав Pro и не понизит текущий сервис немедленно.',
    ),
    "vEntResumeConversion": MessageLookupByLibrary.simpleMessage(
      'Продолжить ожидающее обновление',
    ),
    "vEntUpgradePremium": MessageLookupByLibrary.simpleMessage(
      'Перейти на Pro',
    ),
    "vEntConvertStandardToPremium": MessageLookupByLibrary.simpleMessage(
      'Преобразовать право Standard в продление Pro',
    ),
    "vPlanTierUnknown": MessageLookupByLibrary.simpleMessage(
      'Возможности плана требуют подтверждения',
    ),
    "vPlanTierUnknownDesc": MessageLookupByLibrary.simpleMessage(
      'Уровень плана не распознан. Перед покупкой проверьте актуальное описание сервера.',
    ),
