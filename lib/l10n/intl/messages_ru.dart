...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m77(code) => "Номер авторизации ${code}";
  ...
  static String m80(id) => "Заказ №${id}";

  static String m81(plan, id) => "${plan} — заказ №${id}";

  static String m82(error) => "Не удалось отправить: ${error}";

  static String m83(email) => "Аккаунт: ${email}";

  static String m84(error) => "Не удалось создать заказ: ${error}";

  static String m85(days) => "Действует ${days} дн.";

  static String m86(error) => "Не удалось загрузить тарифы: ${error}";

  static String m87(count) => "${count} устройств(а) онлайн одновременно";

  static String m88(price) => "≈ \$${price} / мес.";

  static String m89(amount) => "${amount} трафика";

  static String m90(amount) => "Скидка ${amount}";

  static String m91(error) => "Не удалось получить расчёт акции: ${error}";
  ...
  static String m107(error) => "Ошибка загрузки: ${error}";

  static String m108(percent) => "Загрузка ${percent}%";

  static String m109(version) => "Требуется обновление до v${version}";

  static String m110(error) => "Не удалось запустить установщик: ${error}";

  static String m111(version) => "Доступна новая версия v${version}";

  static String m112(error) => "Не удалось обновить: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "Автоматически списывается при покупке · при неверной сумме отправьте TXID для зачисления",
    ),
    ...
    "vHelpContactBody": MessageLookupByLibrary.simpleMessage(
      "При обращении в поддержку укажите платформу, версию приложения, сетевую среду, узел и шаги воспроизведения. Не отправляйте пароли, полные платёжные реквизиты или другую конфиденциальную информацию.",
    ),
