...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m68(id) => "Заказ №${id}";

  static String m69(plan, id) => "${plan} — заказ №${id}";

  static String m70(error) => "Не удалось отправить: ${error}";

  static String m71(email) => "Аккаунт: ${email}";

  static String m72(error) => "Не удалось создать заказ: ${error}";

  static String m73(days) => "Действует ${days} дн.";

  static String m74(error) => "Не удалось загрузить тарифы: ${error}";

  static String m75(count) => "${count} устройств(а) онлайн одновременно";

  static String m76(price) => "≈ \$${price} / мес.";

  static String m77(amount) => "${amount} трафика";
  ...
  static String m83(code) =>
      "При регистрации укажите мой код приглашения ${code}";

  static String m84(code) => "Регистрируйтесь с кодом ${code}";
  ...
  static String m88(days) => "${days} дн. бесплатно";

  static String m89(trial, gb) => "Новым пользователям: ${trial}${gb}";

  static String m90(days) =>
      "Новым пользователям — бесплатный пробный период ${days} дн. ";

  static String m91(days, gb) => "${days} дн. · ${gb} ГБ трафика";
  ...
  static String m93(error) => "Ошибка загрузки: ${error}";

  static String m94(percent) => "Загрузка ${percent}%";

  static String m95(version) => "Требуется обновление до v${version}";

  static String m96(error) => "Не удалось запустить установщик: ${error}";

  static String m97(version) => "Доступна новая версия v${version}";

  static String m98(error) => "Не удалось обновить: ${error}";
