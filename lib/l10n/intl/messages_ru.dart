...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctPurchaseBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "Включает неизрасходованные средства заказов · Для новых покупок",
    ),
    ...
    "vCardUseCashBacked": MessageLookupByLibrary.simpleMessage(
      "Использовать денежный баланс (закрывает неоплаченные заказы тарифов и освобождает их скидки)",
    ),
