...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m95(code) =>
      "При регистрации укажите мой код приглашения ${code}";

  static String m96(code) => "Регистрируйтесь с кодом ${code}";
  ...
  static String m100(days) => "${days} дн. бесплатно";

  static String m101(trial, gb) => "Новым пользователям: ${trial}${gb}";

  static String m102(days) =>
      "Новым пользователям — бесплатный пробный период ${days} дн. ";

  static String m103(days, gb) => "${days} дн. · ${gb} ГБ трафика";
  ...
  static String m105(error) => "Ошибка загрузки: ${error}";

  static String m106(percent) => "Загрузка ${percent}%";

  static String m107(version) => "Требуется обновление до v${version}";

  static String m108(error) => "Не удалось запустить установщик: ${error}";

  static String m109(version) => "Доступна новая версия v${version}";

  static String m110(error) => "Не удалось обновить: ${error}";
