...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(amount) => "Баланс: ${amount}";
  ...
  static String m36(amount) => "Выплачено ${amount}";

  static String m37(min) =>
  ...
  static String m39(min, current) =>
      "Вывод доступен от ${min} (сейчас ${current})";

  static String m40(amount) => "Ожидает ${amount} (период созревания 14 дней)";

  static String m41(planId) => "План ${planId}";

  static String m42(list, floor) =>
      "Цена платформы ${list} · ваша закупочная цена ${floor}";

  static String m43(floor, list) => "Должно быть от ${floor} до ${list}";

  static String m44(floor, list) =>
      "Допустимый диапазон ${floor} ~ ${list} (только скидка)";

  static String m45(planId, price) =>
      "Цена для ${planId} установлена: ${price}";

  static String m46(list) => "Не задано (по цене платформы ${list})";

  static String m47(amount) => "В обработке ${amount} (ручная выплата)";

  static String m48(planId) => "Задать цену для ${planId}";
  ...
  static String m51(price, earn) =>
      "Ваша цена ${price} · прибыль ${earn} с заказа";

  static String m52(detail) => "Не удалось подключиться к серверу: ${detail}";

  static String m53(status) => "Ошибка сервера (${status})";

  static String m54(detail) => "Ошибка сертификата TLS: ${detail}";

  static String m55(type) => "Неожиданный тип ответа: ${type}";

  static String m56(status) => "Неожиданный код состояния ${status}";

  static String m57(error) => "Ошибка входа: ${error}";

  static String m58(error) => "Ошибка регистрации: ${error}";

  static String m59(seconds) => "Отправить снова (${seconds} с)";
  ...
  static String m67(id) => "Заказ №${id}";

  static String m68(plan, id) => "${plan} — заказ №${id}";

  static String m69(error) => "Не удалось отправить: ${error}";

  static String m70(email) => "Аккаунт: ${email}";

  static String m71(error) => "Не удалось создать заказ: ${error}";

  static String m72(days) => "Действует ${days} дн.";

  static String m73(error) => "Не удалось загрузить тарифы: ${error}";

  static String m74(count) => "${count} устройств(а) онлайн одновременно";

  static String m75(price) => "≈ \$${price} / мес.";

  static String m76(amount) => "${amount} трафика";

  static String m77(trial, invite, url) =>
      "Verstro — глобальное ускорение сети: подключение в один клик на всех платформах, стабильно и без обрывов. ${trial}${invite}${url}";

  static String m78(trial, invite, url) =>
      "Надоело, что brew / docker / git идут мимо прокси? Verstro через TUN перехватывает весь трафик на системном уровне — консоль и десктопные приложения полностью покрыты, умное переключение между узлами в разных регионах, клиент с открытым кодом под GPLv3. ${trial}${invite}${url}";

  static String m79(trial, invite, url) =>
      "Я пользуюсь Verstro — глобальное ускорение сети с приоритетом приватности. Ускорение всего устройства в один клик, все платформы — телефон и компьютер, стабильно и без обрывов, клиент с открытым кодом и возможностью аудита. ${trial}${invite}Скачать: ${url}";
  ...
  static String m82(code) =>
      "При регистрации укажите мой код приглашения ${code}";

  static String m83(code) => "Регистрируйтесь с кодом ${code}";
  ...
  static String m87(days) => "${days} дн. бесплатно";

  static String m88(trial, gb) => "Новым пользователям: ${trial}${gb}";

  static String m89(days) =>
      "Новым пользователям — бесплатный пробный период ${days} дн. ";

  static String m90(days, gb) => "${days} дн. · ${gb} ГБ трафика";
  ...
  static String m92(error) => "Ошибка загрузки: ${error}";

  static String m93(percent) => "Загрузка ${percent}%";

  static String m94(version) => "Требуется обновление до v${version}";

  static String m95(error) => "Не удалось запустить установщик: ${error}";

  static String m96(version) => "Доступна новая версия v${version}";

  static String m97(error) => "Не удалось обновить: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctAgentTierAgent": MessageLookupByLibrary.simpleMessage("Агент"),
    ...
    "vAcctBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "Автоматически зачитывается при покупке · пере- и недоплаты зачисляются на баланс",
    ),
    ...
    "vAgentTierMaster": MessageLookupByLibrary.simpleMessage("Мастер-агент"),
    "vAgentTierPromoter": MessageLookupByLibrary.simpleMessage("Промоутер"),
    "vAgentTierReseller": MessageLookupByLibrary.simpleMessage("Реселлер"),
    ...
    "vClaimAlreadyProcessed": MessageLookupByLibrary.simpleMessage(
      "Эта транзакция уже обработана и не может быть использована повторно. Вопросы — в поддержку @VerstroSupportBot.",
    ),
    ...
    "vClaimMatchedOtherOrder": MessageLookupByLibrary.simpleMessage(
      "Эта транзакция совпала с другим заказом. Если у вас нет другого заказа, напишите в поддержку @VerstroSupportBot.",
    ),
    "vClaimRejectedManual": MessageLookupByLibrary.simpleMessage(
      "Мы записали транзакцию, но нужна ручная проверка (крупная сумма или особый случай). Напишите в Telegram-поддержку @VerstroSupportBot номер заказа, почту регистрации и ID транзакции (TXID).",
    ),
    "vClaimVerifyFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось проверить транзакцию (возможно, не подтверждена, неверный адрес или сбой сети). Повторите позже или напишите в поддержку @VerstroSupportBot.",
    ),
    ...
    "vPayClaimNote": MessageLookupByLibrary.simpleMessage(
      "После отправки бэкенд сразу проверит транзакцию в блокчейне. При переплате подписка будет активирована, а излишек зачислен на баланс аккаунта; при недоплате вся поступившая сумма зачисляется на баланс и автоматически засчитывается при новом заказе.",
    ),
    "vPayContactSupport": MessageLookupByLibrary.simpleMessage(
      "Связаться с ботом поддержки (не совпала сумма / неверный адрес)",
    ),
    ...
    "vPayTelegramNotInstalled": MessageLookupByLibrary.simpleMessage(
      "Telegram не установлен. Поддержка: @VerstroSupportBot",
    ),
    ...
    "vSharePosterSubline": MessageLookupByLibrary.simpleMessage(
      "Все приложения · стабильно, без обрывов",
    ),
