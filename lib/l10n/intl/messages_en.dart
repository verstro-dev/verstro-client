...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m90(amount) => "Saved ${amount}";

  static String m91(error) => "Unable to get a promotion quote: ${error}";
  ...
  static String m97(code) => "Enter my invite code ${code} when signing up";

  static String m98(code) => "Sign up with invite code ${code}";
  ...
  static String m102(days) => "free ${days}-day trial";

  static String m103(trial, gb) => "New users: ${trial}${gb}";

  static String m104(days) => "New users get a free ${days}-day trial. ";

  static String m105(days, gb) => "${days} days · ${gb} GB of data";

  static String m106(days) =>
      "Verify your email to claim a ${days}-day free trial (enter the 6-digit code from the email)";

  static String m107(error) => "Download failed: ${error}";

  static String m108(percent) => "Downloading ${percent}%";

  static String m109(version) => "Update to v${version} Required";

  static String m110(error) => "Failed to launch installer: ${error}";

  static String m111(version) => "New Version v${version} Available";

  static String m112(error) => "Update failed: ${error}";
