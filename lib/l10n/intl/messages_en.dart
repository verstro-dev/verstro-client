...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(amount) => "Available balance: ${amount}";
  ...
  static String m81(code) => "Authorization ${code}";
  ...
  static String m84(id) => "Order #${id}";

  static String m85(plan, id) => "${plan} order #${id}";

  static String m86(seconds) => "Retry in ${seconds}s";

  static String m87(error) => "Submission failed: ${error}";

  static String m88(email) => "Account: ${email}";

  static String m89(error) => "Failed to create order: ${error}";

  static String m90(days) => "Valid for ${days} days";

  static String m91(error) => "Failed to load plans: ${error}";

  static String m92(count) => "${count} device(s) online at the same time";

  static String m93(price) => "≈ \$${price} / mo";

  static String m94(amount) => "${amount} of data";

  static String m95(amount) => "Saved ${amount}";

  static String m96(error) => "Unable to get a promotion quote: ${error}";
  ...
  static String m102(code) => "Enter my invite code ${code} when signing up";

  static String m103(code) => "Sign up with invite code ${code}";
  ...
  static String m107(days) => "free ${days}-day trial";

  static String m108(trial, gb) => "New users: ${trial}${gb}";

  static String m109(days) => "New users get a free ${days}-day trial. ";

  static String m110(days, gb) => "${days} days · ${gb} GB of data";

  static String m111(days) =>
      "Verify your email to claim a ${days}-day free trial (enter the 6-digit code from the email)";

  static String m112(error) => "Download failed: ${error}";

  static String m113(percent) => "Downloading ${percent}%";

  static String m114(version) => "Update to v${version} Required";

  static String m115(error) => "Failed to launch installer: ${error}";

  static String m116(version) => "New Version v${version} Available";

  static String m117(error) => "Update failed: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "Balance is applied after any discount · pending order funds are not available balance",
    ),
    ...
    "vAcctCreditError": MessageLookupByLibrary.simpleMessage(
      "Unable to load funds. Please retry",
    ),
    "vAcctDaysLater": m22,
    ...
    "vAcctOrderPayCredit": MessageLookupByLibrary.simpleMessage("Balance"),
    "vAcctOrderPayNew": MessageLookupByLibrary.simpleMessage("New payment"),
    ...
    "vAcctPendingContinue": MessageLookupByLibrary.simpleMessage(
      "Continue payment",
    ),
    "vAcctPendingReceived": MessageLookupByLibrary.simpleMessage("Received"),
    "vAcctPendingRemaining": MessageLookupByLibrary.simpleMessage("Remaining"),
    "vAcctPendingSubtitle": MessageLookupByLibrary.simpleMessage(
      "These funds are reserved for their orders, not available for other purchases.",
    ),
    "vAcctPendingTitle": MessageLookupByLibrary.simpleMessage(
      "Received for pending orders",
    ),
    "vAcctPendingTransfer": MessageLookupByLibrary.simpleMessage(
      "Awaiting transfer to balance",
    ),
    ...
    "vAcctPurchaseBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "Includes unspent order funds · balance is applied after any discount",
    ),
    ...
    "vAcctReusablePendingExpired": MessageLookupByLibrary.simpleMessage(
      "Included in available balance. This order has expired; do not send more funds.",
    ),
    "vAcctReusablePendingSubtitle": MessageLookupByLibrary.simpleMessage(
      "Already included in the available balance above; do not add it again. Continue payment, or place a new order to close the old order and reuse the funds.",
    ),
    ...
    "vCardUseCashBacked": MessageLookupByLibrary.simpleMessage(
      "Use account balance (closes unpaid plan orders and releases their discount reservations)",
    ),
    ...
    "vConvAcceptQuote": MessageLookupByLibrary.simpleMessage(
      "Accept new quote and payment order",
    ),
    "vConvAwaiting": MessageLookupByLibrary.simpleMessage(
      "Awaiting payment; existing service continues",
    ),
    "vConvCancel": MessageLookupByLibrary.simpleMessage(
      "Cancel and release held funds",
    ),
    "vConvCancelled": MessageLookupByLibrary.simpleMessage(
      "Conversion cancelled; received funds are released under the balance rules",
    ),
    "vConvCarry": MessageLookupByLibrary.simpleMessage(
      "Funds carried from the previous payment",
    ),
    "vConvCompleted": MessageLookupByLibrary.simpleMessage(
      "Conversion completed",
    ),
    "vConvConfirm": MessageLookupByLibrary.simpleMessage(
      "Confirm and continue",
    ),
    "vConvConverted": MessageLookupByLibrary.simpleMessage("Converted"),
    "vConvCreate": MessageLookupByLibrary.simpleMessage(
      "Accept quote and create conversion",
    ),
    "vConvEndHint": MessageLookupByLibrary.simpleMessage(
      "Only included entitlements end after successful settlement; excluded entitlements remain. Payment does not mean service is active.",
    ),
    "vConvExpired": MessageLookupByLibrary.simpleMessage(
      "Conversion expired; do not continue paying the old order",
    ),
    "vConvHeld": MessageLookupByLibrary.simpleMessage(
      "Conversion funds held (not available balance)",
    ),
    "vConvIdentity": MessageLookupByLibrary.simpleMessage("Conversion ID"),
    "vConvLogin": MessageLookupByLibrary.simpleMessage(
      "Sign in to view conversions",
    ),
    "vConvNew": MessageLookupByLibrary.simpleMessage("Start a new preview"),
    "vConvOpen": MessageLookupByLibrary.simpleMessage("View conversion status"),
    "vConvOpenPayment": MessageLookupByLibrary.simpleMessage(
      "View payment / verify transfer",
    ),
    "vConvQuoteExpired": MessageLookupByLibrary.simpleMessage(
      "Quote expired. Refresh the quote first",
    ),
    "vConvReconfirm": MessageLookupByLibrary.simpleMessage(
      "Review the current quote and funding before confirming",
    ),
    "vConvRecovery": MessageLookupByLibrary.simpleMessage(
      "Safety recovery in progress. Funds and entitlements are preserved; refresh or contact support",
    ),
    "vConvRecoveryHint": MessageLookupByLibrary.simpleMessage(
      "Choose funds received for an expired upgrade, then request a new quote. Only the upgrade difference is covered; any excess stays in your balance. The balance switch only controls other wallet funds.",
    ),
    "vConvRecoveryNone": MessageLookupByLibrary.simpleMessage(
      "Do not use previous payment",
    ),
    "vConvRecoverySource": MessageLookupByLibrary.simpleMessage(
      "Expired payment funds",
    ),
    "vConvRefresh": MessageLookupByLibrary.simpleMessage(
      "Refresh conversion status",
    ),
    "vConvRequote": MessageLookupByLibrary.simpleMessage(
      "Refresh quote (no charge)",
    ),
    "vConvRetryCreate": MessageLookupByLibrary.simpleMessage(
      "Retry the same creation request",
    ),
    "vConvSettling": MessageLookupByLibrary.simpleMessage(
      "Checking final usage; do not repeat the operation",
    ),
    "vConvSource": MessageLookupByLibrary.simpleMessage("Conversion period"),
    "vConvSync": MessageLookupByLibrary.simpleMessage(
      "Conversion committed; service configuration is syncing",
    ),
    "vConvUnknown": MessageLookupByLibrary.simpleMessage(
      "Result not confirmed. Refresh an existing conversion or retry the same creation request; do not pay again.",
    ),
    "vEntActive": MessageLookupByLibrary.simpleMessage("Active"),
    "vEntAdmissionClosed": MessageLookupByLibrary.simpleMessage(
      "New conversions are temporarily closed. Preview only; no funds or entitlements are reserved.",
    ),
    ...
    "vHelpSystemProxyBody": MessageLookupByLibrary.simpleMessage(
      "When enabled, Verstro writes the operating-system proxy settings, so browsers and other apps that honor the system proxy enter Verstro. When disabled, they no longer enter by that route. It needs no virtual adapter and fewer permissions, but terminals, Git, Docker, games, and some desktop apps may ignore it. If web pages fail after force-quitting, open Verstro once to clear leftover system proxy, or turn the proxy off in system settings.",
    ),
    ...
    "vPayConversionBasePriceLabel": MessageLookupByLibrary.simpleMessage(
      "After trade-in (before discounts)",
    ),
    ...
    "vPayLocalExpiryDesc": MessageLookupByLibrary.simpleMessage(
      "Do not send more funds. Server confirmation is still pending. If you have already paid, submit the transaction ID for verification.",
    ),
    "vPayLocalExpiryTitle": MessageLookupByLibrary.simpleMessage(
    ...
    "vPlanRenewalExhausted": MessageLookupByLibrary.simpleMessage(
      "Your plan data is used up. Buy again below. VPN connects only after the new plan is active.",
    ),
    "vPlanRenewalExpired": MessageLookupByLibrary.simpleMessage(
      "Your plan has expired. Buy again below. VPN connects only after the new plan is active.",
    ),
    "vPlanRenewalNone": MessageLookupByLibrary.simpleMessage(
      "You have no active plan. Choose a plan and pay to start.",
    ),
    ...
    "vPromotionApply": MessageLookupByLibrary.simpleMessage("Apply code"),
    ...
    "vPromotionAvailable": MessageLookupByLibrary.simpleMessage("Available"),
    "vPromotionBadge": MessageLookupByLibrary.simpleMessage("Offer available"),
    ...
    "vPromotionHeld": MessageLookupByLibrary.simpleMessage("Processing"),
    "vPromotionMyEntrySubtitle": MessageLookupByLibrary.simpleMessage(
      "View available, used, and expired offers",
    ),
    "vPromotionMyEntryTitle": MessageLookupByLibrary.simpleMessage(
      "My promotions",
    ),
    ...
    "vPromotionCreditBlocked": MessageLookupByLibrary.simpleMessage(
      "This promotion cannot be combined with balance. You pay the discounted price.",
    ),
    "vPromotionCreditPreview": MessageLookupByLibrary.simpleMessage(
      "Estimated payable",
    ),
    ...
    "vPromotionQuoteDiscount": MessageLookupByLibrary.simpleMessage(
      "Promotion",
    ),
    ...
    "vPromotionReleased": MessageLookupByLibrary.simpleMessage("Released"),
    "vPromotionTitle": MessageLookupByLibrary.simpleMessage("Promotions"),
    "vPromotionUnavailable": MessageLookupByLibrary.simpleMessage(
      "Unavailable",
    ),
    "vPromotionUnsupported": MessageLookupByLibrary.simpleMessage(
      "Promotions are not supported by this server version.",
    ),
    "vPromotionUsed": MessageLookupByLibrary.simpleMessage("Used"),
    "vPurchaseAutomaticHint": MessageLookupByLibrary.simpleMessage(
      "Default: higher-tier purchases preview conversion first. Same-tier renewals queue; lower-tier purchases wait. No order is created by the preview.",
    ),
    "vPurchaseEntitlementsUnverified": MessageLookupByLibrary.simpleMessage(
      "Your entitlements could not be verified. Refresh and select the plan again; do not pay a new order.",
    ),
    "vPurchaseHistoryReview": MessageLookupByLibrary.simpleMessage(
      "Your service history needs review. Confirm only if you want a new paid service without converting old value.",
    ),
    "vPurchaseHistoryReviewBody": MessageLookupByLibrary.simpleMessage(
      "This opens a new paid service without converting previous entitlements. Independent purchase is never chosen automatically.",
    ),
    "vPurchaseHistoryReviewOk": MessageLookupByLibrary.simpleMessage(
      "Pay for a new service",
    ),
    "vPurchaseHistoryReviewTitle": MessageLookupByLibrary.simpleMessage(
      "Confirm independent repurchase",
    ),
    "vPurchaseIndependentHint": MessageLookupByLibrary.simpleMessage(
      "Independent purchase: no conversion of existing value. Choose a plan explicitly to create a separate order.",
    ),
    "vPurchaseUpgradeRequired": MessageLookupByLibrary.simpleMessage(
      "Your entitlements now require an upgrade preview. Refresh and select the plan again; no order was created.",
    ),
    ...
    "yearsAgo": m118,
    "vEntRenewPremium": MessageLookupByLibrary.simpleMessage('Renew Pro'),
    "vEntRenewStandard": MessageLookupByLibrary.simpleMessage('Renew Standard'),
    "vAcctOrdersEntitlements": MessageLookupByLibrary.simpleMessage(
      'Orders and entitlements',
    ),
    "vAcctEntitlementTab": MessageLookupByLibrary.simpleMessage('Entitlements'),
    "vAcctOrderTab": MessageLookupByLibrary.simpleMessage('Orders'),
    "vPlanOtherPlans": MessageLookupByLibrary.simpleMessage('Other plans'),
    "vPlanStandardAfterPremium": MessageLookupByLibrary.simpleMessage(
      'Starts only after all Pro entitlements end; it does not downgrade the current service immediately.',
    ),
    "vEntResumeConversion": MessageLookupByLibrary.simpleMessage(
      'Resume pending upgrade',
    ),
    "vEntUpgradePremium": MessageLookupByLibrary.simpleMessage(
      'Upgrade to Pro',
    ),
    "vEntConvertStandardToPremium": MessageLookupByLibrary.simpleMessage(
      'Convert Standard entitlement to Pro renewal',
    ),
    "vPlanTierUnknown": MessageLookupByLibrary.simpleMessage(
      'Plan capabilities pending confirmation',
    ),
    "vPlanTierUnknownDesc": MessageLookupByLibrary.simpleMessage(
      'This plan tier is not recognized. Review the current server details before purchase.',
    ),
