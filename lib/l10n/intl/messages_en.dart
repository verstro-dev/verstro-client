...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vPayLocalExpiryTitle": MessageLookupByLibrary.simpleMessage("Payment window ended"),
    "vPayLocalExpiryDesc": MessageLookupByLibrary.simpleMessage("Do not send more funds. Server confirmation is still pending. If you have already paid, submit the transaction ID for verification."),
    "vAcctPendingTitle": MessageLookupByLibrary.simpleMessage("Received for pending orders"),
    "vAcctPendingSubtitle": MessageLookupByLibrary.simpleMessage("These funds are reserved for their orders, not available for other purchases."),
    ...
    "vAcctPendingTransfer": MessageLookupByLibrary.simpleMessage("Awaiting transfer to balance"),
    "vAcctPendingContinue": MessageLookupByLibrary.simpleMessage("Continue payment"),
    "vAcctCreditError": MessageLookupByLibrary.simpleMessage("Unable to load funds. Please retry"),
