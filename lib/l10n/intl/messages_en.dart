...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m68(id) => "Order #${id}";

  static String m69(plan, id) => "${plan} order #${id}";

  static String m70(error) => "Submission failed: ${error}";

  static String m71(email) => "Account: ${email}";

  static String m72(error) => "Failed to create order: ${error}";

  static String m73(days) => "Valid for ${days} days";

  static String m74(error) => "Failed to load plans: ${error}";

  static String m75(count) => "${count} device(s) online at the same time";

  static String m76(price) => "≈ \$${price} / mo";

  static String m77(amount) => "${amount} of data";
  ...
  static String m83(code) => "Enter my invite code ${code} when signing up";

  static String m84(code) => "Sign up with invite code ${code}";
  ...
  static String m88(days) => "free ${days}-day trial";

  static String m89(trial, gb) => "New users: ${trial}${gb}";

  static String m90(days) => "New users get a free ${days}-day trial. ";

  static String m91(days, gb) => "${days} days · ${gb} GB of data";

  static String m92(days) =>
      "Verify your email to claim a ${days}-day free trial (enter the 6-digit code from the email)";

  static String m93(error) => "Download failed: ${error}";

  static String m94(percent) => "Downloading ${percent}%";

  static String m95(version) => "Update to v${version} Required";

  static String m96(error) => "Failed to launch installer: ${error}";

  static String m97(version) => "New Version v${version} Available";

  static String m98(error) => "Update failed: ${error}";
