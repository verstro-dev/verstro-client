...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m36(amount) => "Paid out ${amount}";
  ...
  static String m40(amount) => "Maturing ${amount} (14-day maturation period)";

  static String m41(planId) => "Plan ${planId}";

  static String m42(list, floor) => "List price ${list} · your cost ${floor}";

  static String m43(floor, list) => "Must be between ${floor} and ${list}";

  static String m44(floor, list) =>
      "Allowed range ${floor} ~ ${list} (discounts only)";

  static String m45(planId, price) => "Price for ${planId} set to ${price}";

  static String m46(list) => "Not set (charged at list price ${list})";

  static String m47(amount) =>
      "Processing ${amount} (manual payout in progress)";

  static String m48(planId) => "Set price for ${planId}";
  ...
  static String m52(detail) => "Could not connect to the server: ${detail}";

  static String m53(status) => "Server error (${status})";

  static String m54(detail) => "TLS certificate error: ${detail}";

  static String m55(type) => "Unexpected response type: ${type}";

  static String m56(status) => "Unexpected status code ${status}";

  static String m57(error) => "Sign-in failed: ${error}";

  static String m58(error) => "Sign-up failed: ${error}";

  static String m59(seconds) => "Resend (${seconds}s)";
  ...
  static String m67(id) => "Order #${id}";

  static String m68(plan, id) => "${plan} order #${id}";

  static String m69(error) => "Submission failed: ${error}";

  static String m70(email) => "Account: ${email}";

  static String m71(error) => "Failed to create order: ${error}";

  static String m72(days) => "Valid for ${days} days";

  static String m73(error) => "Failed to load plans: ${error}";

  static String m74(count) => "${count} device(s) online at the same time";

  static String m75(price) => "≈ \$${price} / mo";

  static String m76(amount) => "${amount} of data";
  ...
  static String m82(code) => "Enter my invite code ${code} when signing up";

  static String m83(code) => "Sign up with invite code ${code}";
  ...
  static String m87(days) => "free ${days}-day trial";

  static String m88(trial, gb) => "New users: ${trial}${gb}";

  static String m89(days) => "New users get a free ${days}-day trial. ";

  static String m90(days, gb) => "${days} days · ${gb} GB of data";

  static String m91(days) =>
      "Verify your email to claim a ${days}-day free trial (enter the 6-digit code from the email)";

  static String m92(error) => "Download failed: ${error}";

  static String m93(percent) => "Downloading ${percent}%";

  static String m94(version) => "Update to v${version} Required";

  static String m95(error) => "Failed to launch installer: ${error}";

  static String m96(version) => "New Version v${version} Available";

  static String m97(error) => "Update failed: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctAgentTierAgent": MessageLookupByLibrary.simpleMessage("Agent"),
    ...
    "vAcctBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "Auto-applied at checkout · over- and underpayments are saved to your balance",
    ),
    ...
    "vAgentTierMaster": MessageLookupByLibrary.simpleMessage("Master agent"),
    "vAgentTierPromoter": MessageLookupByLibrary.simpleMessage("Promoter"),
    "vAgentTierReseller": MessageLookupByLibrary.simpleMessage("Reseller"),
    ...
    "vPayFeeWarningBody": MessageLookupByLibrary.simpleMessage(
      "Exchanges deduct a network fee from the withdrawal amount (typically ~1 USDT on TRC20), so the amount received will be less than what you entered and the payment cannot be matched automatically. We recommend transferring directly from your own wallet (imToken / TronLink). If you must use an exchange, set withdrawal amount = amount due + fee, so the received amount exactly equals the amount due. If you overpay, your subscription is activated and the excess is credited to your account balance; if you underpay, the full received amount is credited to your balance and applied automatically when you reorder.",
    ),
