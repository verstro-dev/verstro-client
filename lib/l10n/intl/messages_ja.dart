...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m95(code) => "登録時に私の招待コード ${code} を入力してください";

  static String m96(code) => "登録時に招待コード ${code} を入力";

  static String m97(prefix, amount) =>
      "${prefix}。初回購入後に ${amount} 分のクレジットがもらえます。";

  static String m98(amount) => "コード入力で登録 · 初回購入後お互いに ${amount}";

  static String m99(amount) => "コード入力で登録 · 初回購入で ${amount} 分のクレジット";

  static String m100(days) => "${days}日間無料トライアル";

  static String m101(trial, gb) => "新規ユーザー：${trial}${gb}";

  static String m102(days) => "新規ユーザーは ${days} 日間の無料トライアルが利用できます。";

  static String m103(days, gb) => "${days} 日間 · ${gb}GB のデータ通信量";

  static String m104(days) =>
      "メール認証をすると ${days} 日間の無料トライアルを受け取れます（メール内の 6 桁のコードを入力）";

  static String m105(error) => "ダウンロードに失敗しました: ${error}";

  static String m106(percent) => "ダウンロード中 ${percent}%";

  static String m107(version) => "v${version} への更新が必要です";

  static String m108(error) => "インストーラーの起動に失敗しました: ${error}";

  static String m109(version) => "新しいバージョン v${version} が利用可能です";

  static String m110(error) => "更新に失敗しました: ${error}";

  static String m111(count) => "${count}年前";
