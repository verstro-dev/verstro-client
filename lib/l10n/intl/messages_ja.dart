...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m63(amount) =>
      "この注文は期限切れでしたが、送金を受領しました。${amount} はアカウント残高に全額入金されました。再度ご注文ください——残高は自動適用され、全額に達すれば即時有効化されます。";

  static String m64(amount) =>
      "${amount} がアカウント残高に入金されました。再度ご注文ください——残高は自動的に適用されます。";

  static String m65(amount, shortfall) =>
      "入金額が請求額を下回りました。${amount} はアカウント残高に全額入金され、元の注文は無効になりました。再度ご注文ください——残高は自動的に適用され、差額 ${shortfall} のみお支払いいただきます。";

  static String m66(basePrice) =>
      "プラン基本料金 \$${basePrice} + 照合用の端数。0.01 でも多いか少ないと自動照合できません。ウォレットの「金額」欄が小数点以下 2 桁まで一致しているか確認してください。";

  static String m67(id) => "注文 #${id} は 24 時間以内に支払いが確認されなかったため、自動的に無効になりました。";

  static String m68(id) => "注文 #${id}";

  static String m69(plan, id) => "${plan} 注文 #${id}";

  static String m70(error) => "送信に失敗しました: ${error}";

  static String m71(email) => "アカウント: ${email}";

  static String m72(error) => "注文の作成に失敗しました: ${error}";

  static String m73(days) => "${days} 日間有効";

  static String m74(error) => "プランの読み込みに失敗しました: ${error}";

  static String m75(count) => "${count} 台のデバイスで同時接続";

  static String m76(price) => "約 \$${price} / 月";

  static String m77(amount) => "データ通信量 ${amount}";
  ...
  static String m80(trial, invite, url) =>
  ...
  static String m81(prefix, amount) =>
      "${prefix}。初回購入後、あなたにも私にも ${amount} 分のクレジットが付与されます。";

  static String m82(prefix) => "${prefix}。";

  static String m83(code) => "登録時に私の招待コード ${code} を入力してください";

  static String m84(code) => "登録時に招待コード ${code} を入力";

  static String m85(prefix, amount) =>
      "${prefix}。初回購入後に ${amount} 分のクレジットがもらえます。";

  static String m86(amount) => "コード入力で登録 · 初回購入後お互いに ${amount}";

  static String m87(amount) => "コード入力で登録 · 初回購入で ${amount} 分のクレジット";

  static String m88(days) => "${days}日間無料トライアル";

  static String m89(trial, gb) => "新規ユーザー：${trial}${gb}";

  static String m90(days) => "新規ユーザーは ${days} 日間の無料トライアルが利用できます。";

  static String m91(days, gb) => "${days} 日間 · ${gb}GB のデータ通信量";

  static String m92(days) =>
      "メール認証をすると ${days} 日間の無料トライアルを受け取れます（メール内の 6 桁のコードを入力）";

  static String m93(error) => "ダウンロードに失敗しました: ${error}";

  static String m94(percent) => "ダウンロード中 ${percent}%";

  static String m95(version) => "v${version} への更新が必要です";

  static String m96(error) => "インストーラーの起動に失敗しました: ${error}";

  static String m97(version) => "新しいバージョン v${version} が利用可能です";

  static String m98(error) => "更新に失敗しました: ${error}";

  static String m99(count) => "${count}年前";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctAgentTierAgent": MessageLookupByLibrary.simpleMessage("代理店"),
    "vAcctAgentTierMaster": MessageLookupByLibrary.simpleMessage("マスター代理店"),
    "vAcctAgentWithdrawable": m19,
    "vAcctBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "購入時に自動で充当 · 過払い/不足分は自動的に残高へ入金",
    ),
    ...
    "vAgentTierMaster": MessageLookupByLibrary.simpleMessage("マスター代理店"),
    "vAgentTierPromoter": MessageLookupByLibrary.simpleMessage("プロモーター"),
    "vAgentTierReseller": MessageLookupByLibrary.simpleMessage("代理店"),
    ...
    "vPayAmountMismatchNoteWithBase": m66,
    ...
    "vPayClaimNote": MessageLookupByLibrary.simpleMessage(
      "送信後、バックエンドがすぐにオンチェーンで確認します。多く支払った場合はそのまま開通し、超過分はアカウント残高に入金されます。不足の場合は着金額が全額残高に入金され、再注文時に自動で充当されます。",
    ),
    ...
    "vPayFeeWarningBody": MessageLookupByLibrary.simpleMessage(
      "取引所の出金ではネットワーク手数料（TRC20 では約 1 USDT が一般的）が出金数量から差し引かれるため、着金額が入力額より少なくなり、自動照合できなくなります。ご自身のウォレット（imToken / TronLink）から直接送金することをおすすめします。取引所を使う場合は「出金数量 = 支払金額 + 手数料」とし、着金数量が支払金額と正確に一致するようにしてください。多く支払った場合はそのまま開通し、超過分はアカウント残高に入金されます。不足の場合は着金額が全額残高に入金され、再注文時に自動で充当されます。",
    ),
    ...
    "vPlanCreateOrderFailed": m72,
    "vPlanDurationDays": m73,
    ...
    "vShareCopyDev": m79,
    "vShareCopyGeneral": m80,
    "vShareCopyTitle": MessageLookupByLibrary.simpleMessage("シェア用テキスト"),
    "vShareGenerating": MessageLookupByLibrary.simpleMessage("生成中…"),
    "vShareInviteBoth": m81,
    "vShareInvitePlain": m82,
    "vShareInvitePrefix": m83,
    "vShareInvitePrefixBrief": m84,
    "vShareInviteReferee": m85,
    ...
    "vUpdDownloadFailed": m93,
    "vUpdDownloadingProgress": m94,
