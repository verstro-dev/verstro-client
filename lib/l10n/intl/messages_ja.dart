...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m36(amount) => "送金済み ${amount}";

  static String m37(min) => "出金可能残高が不足しています。最低出金額は ${min} です。";
  ...
  static String m39(min, current) => "${min} 以上で出金可能（現在 ${current}）";

  static String m40(amount) => "確定待ち ${amount}（14 日間の確定期間）";

  static String m41(planId) => "プラン ${planId}";

  static String m42(list, floor) => "定価 ${list} · 仕入価格 ${floor}";

  static String m43(floor, list) => "${floor} ~ ${list} の範囲で入力してください";

  static String m44(floor, list) => "設定可能範囲 ${floor} ~ ${list}（値引きのみ）";

  static String m45(planId, price) => "${planId} の販売価格を ${price} に設定しました";

  static String m46(list) => "未設定（定価 ${list} で販売）";

  static String m47(amount) => "処理中 ${amount}（手動送金中）";

  static String m48(planId) => "${planId} の販売価格を設定";

  static String m49(code, url) =>
      "私の招待コード ${code} で Verstro に登録すると、初回購入であなたにも特典があります！ダウンロード：${url}";

  static String m50(count, amount) =>
      "サブ代理店 ${count} 人 · override 出金可能 ${amount}";

  static String m51(price, earn) => "販売価格 ${price} · 1 件あたり ${earn} の利益";

  static String m52(detail) => "サーバーに接続できません：${detail}";

  static String m53(status) => "サーバーエラー (${status})";

  static String m54(detail) => "TLS 証明書エラー：${detail}";

  static String m55(type) => "予期しないレスポンス形式：${type}";

  static String m56(status) => "予期しないステータスコード ${status}";

  static String m57(error) => "ログインに失敗しました: ${error}";

  static String m58(error) => "登録に失敗しました: ${error}";

  static String m59(seconds) => "再送信（${seconds} 秒）";

  static String m60(email) =>
      "確認コードを ${email} に送信しました（迷惑メールもご確認ください）。\n6 桁のコードを入力し、新しいパスワードを設定してください。";

  static String m61(amount) =>
  ...
  static String m66(id) => "注文 #${id} は 24 時間以内に支払いが確認されなかったため、自動的に無効になりました。";

  static String m67(id) => "注文 #${id}";

  static String m68(plan, id) => "${plan} 注文 #${id}";

  static String m69(error) => "送信に失敗しました: ${error}";

  static String m70(email) => "アカウント: ${email}";

  static String m71(error) => "注文の作成に失敗しました: ${error}";

  static String m72(days) => "${days} 日間有効";

  static String m73(error) => "プランの読み込みに失敗しました: ${error}";

  static String m74(count) => "${count} 台のデバイスで同時接続";

  static String m75(price) => "約 \$${price} / 月";

  static String m76(amount) => "データ通信量 ${amount}";
  ...
  static String m80(prefix, amount) =>
      "${prefix}。初回購入後、あなたにも私にも ${amount} 分のクレジットが付与されます。";

  static String m81(prefix) => "${prefix}。";

  static String m82(code) => "登録時に私の招待コード ${code} を入力してください";

  static String m83(code) => "登録時に招待コード ${code} を入力";

  static String m84(prefix, amount) =>
      "${prefix}。初回購入後に ${amount} 分のクレジットがもらえます。";

  static String m85(amount) => "コード入力で登録 · 初回購入後お互いに ${amount}";

  static String m86(amount) => "コード入力で登録 · 初回購入で ${amount} 分のクレジット";

  static String m87(days) => "${days}日間無料トライアル";

  static String m88(trial, gb) => "新規ユーザー：${trial}${gb}";

  static String m89(days) => "新規ユーザーは ${days} 日間の無料トライアルが利用できます。";

  static String m90(days, gb) => "${days} 日間 · ${gb}GB のデータ通信量";

  static String m91(days) =>
      "メール認証をすると ${days} 日間の無料トライアルを受け取れます（メール内の 6 桁のコードを入力）";

  static String m92(error) => "ダウンロードに失敗しました: ${error}";

  static String m93(percent) => "ダウンロード中 ${percent}%";

  static String m94(version) => "v${version} への更新が必要です";

  static String m95(error) => "インストーラーの起動に失敗しました: ${error}";

  static String m96(version) => "新しいバージョン v${version} が利用可能です";

  static String m97(error) => "更新に失敗しました: ${error}";
