...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(amount) => "アカウント残高: ${amount}";
  ...
  static String m77(code) => "認定番号 ${code}";

  static String m78(basePrice) =>
      "プラン基本料金 \$${basePrice} + 照合用の端数。0.01 でも多いか少ないと自動照合できません。ウォレットの「金額」欄が小数点以下 2 桁まで一致しているか確認してください。";

  static String m79(id) => "注文 #${id} は 24 時間以内に支払いが確認されなかったため、自動的に無効になりました。";

  static String m80(id) => "注文 #${id}";

  static String m81(plan, id) => "${plan} 注文 #${id}";

  static String m82(error) => "送信に失敗しました: ${error}";

  static String m83(email) => "アカウント: ${email}";

  static String m84(error) => "注文の作成に失敗しました: ${error}";

  static String m85(days) => "${days} 日間有効";

  static String m86(error) => "プランの読み込みに失敗しました: ${error}";

  static String m87(count) => "${count} 台のデバイスで同時接続";

  static String m88(price) => "約 \$${price} / 月";

  static String m89(amount) => "データ通信量 ${amount}";

  static String m90(amount) => "${amount} 割引";

  static String m91(error) => "プロモーション見積もりを取得できません：${error}";

  static String m92(trial, invite, url) =>
      "Verstro グローバルネットワーク加速：全プラットフォームでワンタップ接続、安定して途切れません。${trial}${invite}${url}";

  static String m93(trial, invite, url) =>
      "brew / docker / git がプロキシを通らずお困りですか？Verstro は TUN でシステムレベルの全トラフィックを引き受け、CLI もデスクトップアプリも全部カバー。複数リージョンのノードをスマートに切り替え、クライアントは GPLv3 のオープンソースで監査可能です。${trial}${invite}${url}";

  static String m94(trial, invite, url) =>
      "Verstro を使っています —— プライバシー第一のグローバルネットワーク加速。ワンタップで全体を加速、スマホも PC も全プラットフォーム対応、安定して途切れず、クライアントはオープンソースで監査可能。${trial}${invite}ダウンロード：${url}";

  static String m95(prefix, amount) =>
      "${prefix}。初回購入後、あなたにも私にも ${amount} 分のクレジットが付与されます。";

  static String m96(prefix) => "${prefix}。";

  static String m97(code) => "登録時に私の招待コード ${code} を入力してください";

  static String m98(code) => "登録時に招待コード ${code} を入力";

  static String m99(prefix, amount) =>
      "${prefix}。初回購入後に ${amount} 分のクレジットがもらえます。";

  static String m100(amount) => "コード入力で登録 · 初回購入後お互いに ${amount}";

  static String m101(amount) => "コード入力で登録 · 初回購入で ${amount} 分のクレジット";

  static String m102(days) => "${days}日間無料トライアル";

  static String m103(trial, gb) => "新規ユーザー：${trial}${gb}";

  static String m104(days) => "新規ユーザーは ${days} 日間の無料トライアルが利用できます。";

  static String m105(days, gb) => "${days} 日間 · ${gb}GB のデータ通信量";

  static String m106(days) =>
      "メール認証をすると ${days} 日間の無料トライアルを受け取れます（メール内の 6 桁のコードを入力）";

  static String m107(error) => "ダウンロードに失敗しました: ${error}";

  static String m108(percent) => "ダウンロード中 ${percent}%";

  static String m109(version) => "v${version} への更新が必要です";

  static String m110(error) => "インストーラーの起動に失敗しました: ${error}";

  static String m111(version) => "新しいバージョン v${version} が利用可能です";

  static String m112(error) => "更新に失敗しました: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vAcctBalanceSubtitle": MessageLookupByLibrary.simpleMessage(
      "購入時に自動で充当 · 金額相違は TXID 送信後に残高へ入金",
    ),
    ...
    "vClaimAlreadyProcessed": MessageLookupByLibrary.simpleMessage(
      "この取引は既に処理済みで、再利用できません。ご不明な点はサポート @VerstroSupportBot まで。",
    ),
    ...
    "vClaimMatchedOtherOrder": MessageLookupByLibrary.simpleMessage(
      "この取引は別の注文に一致しました。他に注文がない場合はサポート @VerstroSupportBot までご連絡ください。",
    ),
    "vClaimRejectedManual": MessageLookupByLibrary.simpleMessage(
      "取引を記録しましたが、手動確認が必要です（高額または特殊なケース）。Telegram サポート @VerstroSupportBot に注文番号・登録メール・取引 ID（TXID）を添えてご連絡ください。",
    ),
    "vClaimVerifyFailed": MessageLookupByLibrary.simpleMessage(
      "この取引を確認できませんでした（未確認・アドレス誤り・ネットワークの乱れの可能性）。しばらくして再試行するか、サポート @VerstroSupportBot までご連絡ください。",
    ),
    ...
    "vHelpContactBody": MessageLookupByLibrary.simpleMessage(
      "サポートへの連絡時は、プラットフォーム、アプリのバージョン、ネットワーク環境、ノード、再現手順を知らせてください。パスワード、完全な支払い認証情報、その他の機密情報は送らないでください。",
    ),
    "vHelpContactTitle": MessageLookupByLibrary.simpleMessage("サポートに連絡"),
    ...
    "vPayClaimNote": MessageLookupByLibrary.simpleMessage(
      "送信後、バックエンドがすぐにオンチェーンで確認します。金額が異なる場合は TXID を送信してください。過払いは開通して超過分を残高へ入金し、不足分は着金額を全額残高へ入金して再注文時に自動で充当します。",
    ),
    "vPayContactSupport": MessageLookupByLibrary.simpleMessage(
      "サポート Bot に連絡（金額不一致 / アドレス間違い）",
    ),
    ...
    "vPayTelegramNotInstalled": MessageLookupByLibrary.simpleMessage(
      "Telegram がインストールされていません。サポート: @VerstroSupportBot",
    ),
    ...
    "vShareCopyDev": m93,
    "vShareCopyGeneral": m94,
    "vShareCopyTitle": MessageLookupByLibrary.simpleMessage("シェア用テキスト"),
    "vShareGenerating": MessageLookupByLibrary.simpleMessage("生成中…"),
    "vShareInviteBoth": m95,
    "vShareInvitePlain": m96,
    "vShareInvitePrefix": m97,
    "vShareInvitePrefixBrief": m98,
    "vShareInviteReferee": m99,
    ...
    "vSharePosterFeat1Label": MessageLookupByLibrary.simpleMessage("真・全体プロキシ"),
    ...
    "vSharePosterFeat4Label": MessageLookupByLibrary.simpleMessage("全OS対応"),
    ...
    "vUpdDownloadFailed": m107,
    "vUpdDownloadingProgress": m108,
