...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m73(amount) =>
      "確認しました。サブスクリプションが有効です。多く支払った ${amount} はアカウント残高に加算され、次回自動的に適用されます。";
  ...
  static String m78(count) => "${count} 件の取引で支払いが完了し、サブスクリプションが有効になりました。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "vPayLocalExpiryDesc": MessageLookupByLibrary.simpleMessage("追加送金しないでください。サーバーの最終確認を待っています。支払い済みの場合は取引IDを送信して確認してください。"),
    "vAcctPendingTitle": MessageLookupByLibrary.simpleMessage("支払い待ち注文の受領額"),
    "vAcctPendingSubtitle": MessageLookupByLibrary.simpleMessage("この資金は該当注文専用で、他の購入には利用できません。"),
    ...
    "vAcctCreditError": MessageLookupByLibrary.simpleMessage("残高を読み込めません。再試行してください"),
    ...
    "vPayOrderNumber": m84,
    "vPayOrderTitle": m85,
    "vPayPaymentConfirmed": MessageLookupByLibrary.simpleMessage("支払いが確認されました"),
