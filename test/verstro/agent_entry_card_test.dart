...
void main() {
  ...
  testWidgets('master + 有余额: Chip 与金额并存, 360dp 窄屏不溢出', (tester) async {
    await pumpCard(tester, agent(tier: 'master', availableCents: 123456),
        surface: const Size(360, 640));
    expect(find.text('可提现 \$1234.56'), findsOneWidget);
    expect(find.text('总代'), findsOneWidget);
