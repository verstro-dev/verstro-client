...
class PendingApi extends BackendApi {
  ...
  }) async => AccountEntitlements.fromJson({
    'as_of': '2026-09-09T00:00:00Z',
    'revision': 'fixture',
    'current_service': {'status': 'pending_sync'},
    'current': [],
    'pending': [],
    'history': [],
  ...
  Future<OrderDto> getOrder(int id) async {
    ...
    return exactOrder ?? order(status);
  }
}
