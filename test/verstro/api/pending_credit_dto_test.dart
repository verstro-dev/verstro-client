...
void main() {
  test('新购买余额包含部分付款且不得重复相加', () {
    final data = response()
      ..['purchase_balance_cents'] = 110
      ..['reusable_held_cents'] = 0;
    expect(CreditDto.fromJson(data).purchaseBalanceCents, 110);
    data['purchase_balance_cents'] = 111;
    expect(() => CreditDto.fromJson(data), throwsFormatException);
  });
