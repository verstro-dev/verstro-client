...
void main() {
  test('JSON 报价保留服务端 tier、9/10 分类和 cash-backed 拆分', () {
    final quote = MembershipCardQuote.fromJson(<String, dynamic>{
      ...
      'promotional_credit_applied_cents': 200,
      'credit_available_cents': 1500,
    ...
    expect(quote.promotionalCreditAppliedCents, 200);
    expect(quote.displayedCreditAppliedCents, 900);
    expect(quote.cashDueCents, 2600);
